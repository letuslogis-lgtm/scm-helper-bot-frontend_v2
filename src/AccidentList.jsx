                ...
                {isAdvancedOpen && (
                    <div className="flex flex-col gap-3 pt-3 mt-1 border-t border-gray-100 slide-up">
                        <div className="flex items-center gap-6 w-full flex-wrap">
                            ...
                            <MultiSelect label="귀책부서" options={['물류사업1팀', '물류사업2팀', '운송사업팀', '컨택센터', '라스트마일1팀', '라스트마일2팀', '구매/생산', '브랜드/3PL고객사', '기타']} selected={draftFilters.depts} onChange={(val) => setDraftFilters({ ...draftFilters, depts: val })} width="w-40" />
